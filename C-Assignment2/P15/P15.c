 ...
 * -------------------------------------------------
 * 		0000 0000 0000 0000 0000 0000 0000 0001			>>>>onesCount++   1
 *
 * then we shift right the number to check the next bit
 * 		0000 0000 0000 0000 0000 0001 1111 1011
 * 	 &	0000 0000 0000 0000 0000 0000 0000 0001
 * -------------------------------------------------
 * 		0000 0000 0000 0000 0000 0000 0000 0001			>>>>onesCount++   2
 *
 * then we shift right the number to check the next bit
 * 		0000 0000 0000 0000 0000 0000 1111 1101
 * 	 &	0000 0000 0000 0000 0000 0000 0000 0001
 * -------------------------------------------------
 * 		0000 0000 0000 0000 0000 0000 0000 0001			>>>>onesCount++   3
 *
 * then we shift right the number to check the next bit
 * 		0000 0000 0000 0000 0000 0001 1111 1011
 * 	 &	0000 0000 0000 0000 0000 0000 0000 0001
 * -------------------------------------------------
 * 		0000 0000 0000 0000 0000 0000 0000 0001			>>>>onesCount++   4
 *
 * 	then we shift right the number to check the next bit
 * 		0000 0000 0000 0000 0000 0000 1111 1101
 * 	 &	0000 0000 0000 0000 0000 0000 0000 0001
 * -------------------------------------------------
 * 		0000 0000 0000 0000 0000 0000 0000 0001			>>>>onesCount++	  5
 *
 * 	then we shift right the number to check the next bit
 * 		0000 0000 0000 0000 0000 0000 0111 1110
 * 	 &	0000 0000 0000 0000 0000 0000 0000 0001
 * -------------------------------------------------
 * 		0000 0000 0000 0000 0000 0000 0000 0000			>>>>nothing happens, increases the loop counter.
 *
 *
 * 		and so on
 * */
